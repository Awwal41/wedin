        ...
        >
          ...
          >
            <motion.button
              ...
              className="bg-soft-green hover:bg-dusty-pink text-black font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 shadow-lg hover:shadow-xl"
            >
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-dusty-pink/5 to-soft-green/5 rounded-2xl p-8 border-2 border-dusty-pink/20"
          >
            <h3 className="text-3xl md:text-4xl font-script text-text-gray mb-6">
              Thank You
            </h3>
            <p className="text-lg md:text-xl text-text-gray/80 leading-relaxed">
