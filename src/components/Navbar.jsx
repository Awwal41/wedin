        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <button 
              ...
              className="text-text-gray hover:text-dusty-pink focus:outline-none transition-colors duration-300"
            >
              {isMobileMenuOpen ? (
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-white/95 backdrop-blur-sm border-t border-dusty-pink/20"
            >
                  ...
                  <Link
                    ...
                    className={`block px-4 py-3 rounded-lg text-lg font-medium transition-colors duration-300 ${
                      location.pathname === item.path
                        ...
                        : 'text-text-gray hover:bg-dusty-pink/10 hover:text-dusty-pink'
                    }`}
                  >
                    {item.name}
                  </Link>
